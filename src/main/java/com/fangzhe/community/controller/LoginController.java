...
public class LoginController implements CommunityConstant {
    ...
    public String login(String username, String password, String code,
                        boolean rememberme, Model model, HttpSession session, HttpServletResponse servletResponse){
    //判断验证码
        String kapcha = (String) session.getAttribute("kaptcha");
        if(StringUtils.isBlank(kapcha) || StringUtils.isBlank(code) || !kapcha.equalsIgnoreCase(code)){
