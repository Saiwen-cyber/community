...
import com.fangzhe.community.CommunityApplication;
...
public class CaffeineTests {
    ...
    @Autowired
    private DiscussPosService postService;
    ...
    public void testCache() {
        System.out.println(postService.findDiscussPosts(0, 0, 10, 1).get(0).getTitle());
        System.out.println(postService.findDiscussPosts(0, 0, 10, 1).get(0).getTitle());
        System.out.println(postService.findDiscussPosts(0, 0, 10, 1).get(0).getTitle());
        System.out.println(postService.findDiscussPosts(0, 0, 10, 0).get(0).getTitle());
    }
